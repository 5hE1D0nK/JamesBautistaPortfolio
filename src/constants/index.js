...
export const HERO_CONTENT = `I am a third-year Software Engineering student at Concordia University with hands-on experience in full-stack development and API integration. My technical expertise spans programming languages like Python, Java, and JavaScript, along with frameworks and tools such as React, Node.js, Express.js, and MongoDB. I have developed practical solutions including a Google Calendar Coding Hours Tracker with OAuth2 authentication, a Smart Course & Schedule Planner with dynamic constraint handling, and a Peer Assessment Application using Agile methodology, demonstrating my ability to create efficient software solutions for real-world productivity and academic challenges.`;

export const ABOUT_TEXT = `I am a motivated third-year Software Engineering student at Concordia University, passionate about solving problems and building practical applications. With proficiency in Python, Java, and JavaScript, I specialize in full-stack development using frameworks like React, Node.js, and Express.js. My project experience includes a Peer Assessment Application developed using Agile methodology, a Google Calendar Coding Hours Tracker with OAuth2 authentication, and a Smart Course & Schedule Planner with dynamic constraint handling, showcasing both technical expertise and creative problem-solving. Beyond academics, I have developed precision and adaptability as a Contractor Apprentice, working on residential renovation projects. I thrive in collaborative settings, contributing effectively to team-driven projects and hackathons like ConUHacks and PolyHacks. Fluent in English and French, I enjoy music, gaming, fitness, and cooking while continuously exploring new technological challenges.`;
